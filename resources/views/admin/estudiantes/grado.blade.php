...
@section('head')
    ...
    <title>{{ __('Change Grade') }} - {{ $estudiante->user->name }} - {{ config('app.name', 'Sistema') }}</title>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($grados as $grado)
                                            <tr class="item">
                                                ...
                                                <td class="text-right">
                                                    @can('admin.estudiante.confirmargrado')
                                                        <a  href="{{ route('admin.estudiante.confirmargrado', [$estudiante->id, $grado->id]) }}"
