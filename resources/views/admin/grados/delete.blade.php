...
@section('head')
    ...
    <title>{{ __('Delete Grade') }} - {{ config('app.name', 'Sistema') }}</title>
    ...
    <div class="content-wrapper text-sm">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <form action="{{ route('admin.grado.destroy', [$grado->id]) }}" method="POST" novalidate>
                    @csrf
                    @method('DELETE')
                            ...
                            <div class="card shadow-none">
                                ...
                                <div class="card-body">
                                    <div class="row p-md-3">
                                        ...
                                        <div class="col-12">
                                            <h3>¿ {{ __('Are you sure you want to eliminate the degree of') }}
                                                <span class="font-weight-bold">{{ $grado->nombre }} - {{ $grado->seccion }}</span>
                                                ?
                                            </h3>

                                            <p class="text-muted my-4">
                                                {{ __("To confirm that you want to delete the grade, write the word 'DELETE' in the text box and activate the checkbox") }}
                                            </p>
                                        </div>
