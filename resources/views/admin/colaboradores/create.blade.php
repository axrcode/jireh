...
@section('head')
    ...
    <title>{{ __('Create Collaborator') }} - {{ config('app.name', 'Sistema') }}</title>
    ...
    <div class="content-wrapper text-sm">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <form action="{{ route('admin.colaborador.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    value="{{ old('usuario') }}"
                                                >
                                                    <option value="">{{ trans('forms-collaborator.select_user') }}</option>
                        ...
                        <div class="offset-md-6 col-md-3 mb-3">
                            <a
                                href="{{ route('admin.colaborador.index') }}"
