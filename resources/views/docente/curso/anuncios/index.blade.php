...
@section('head')
    ...
    <title>Anuncios - {{ $curso->nombre }} - {{ $curso->grado->nombre }} - {{ config('app.name', 'Sistema') }}</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-9">
                                ...
                                <div class="col-12 col-md-3 offset-md-9 mb-3 p-0">
                                    <a  href="{{ route('docente.curso.anuncios.create', [$curso]) }}"
                                ...
                                @livewire('docente.cursos.anuncios', [$curso->id])
...
@section('scripts')
    ...
    <script src="/scripts/tertiary-datatable.js"></script>
