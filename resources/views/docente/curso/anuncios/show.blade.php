...
@section('head')
    ...
    <title>Ver Anuncio - {{ $curso->nombre }} - {{ $curso->grado->nombre }} - {{ config('app.name', 'Sistema') }}</title>
                                        ...
                                        <div class="card-tools">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                    ...
                                                    <a  href="{{ route('docente.curso.anuncios.edit', [$curso->id, $anuncio->id]) }}"
                                                        class="dropdown-item">
                                                        Editar
                                                    </a>
                                                ...
                                                <div class="text-muted mt-4">
                                                    <p class="text-sm font-weight-bold">
                                                        ...
                                                        <span class="d-block font-weight-normal">
                                                            {{ date('d/m/Y, g:i a', strtotime($anuncio->created_at)) }}</span>
                                                        </span>
                                                    </p>
                                                </div>
